 ...
 * @constructor
 */
function quarkDb(filePath, options) {
 ...
 */
quarkDb.prototype.set = function(key, value) {
 ...
 */
quarkDb.prototype.get = function(key) {
 ...
 */
quarkDb.prototype.has = function(key) {
 ...
 */
quarkDb.prototype.delete = function(key) {
 ...
 * @returns {object} The quarkDb instance itself.
 */
quarkDb.prototype.deleteAll = function() {
 ...
 */
quarkDb.prototype.sync = function() {
 ...
 */
quarkDb.prototype.JSON = function(storage) {
	if (storage) {
		try {
